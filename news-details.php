						...
						<div class="comment-one">
							...
							<div class="comment-one__single">
								...
								<div class="comment-one__content">
									...
									<a href="news-details.html" class="theme-btn btn-style-two comment-one__btn"><span class="btn-title">Reply</span></a>
								</div>
							</div>
							<div class="comment-one__single">
							...
							<div class="comment-form">
								...
								<form id="contact_form" name="contact_form" class="" action="https://kodesolution.com/html/2023/crotive-html/includes/sendmail.php" method="post">
									<div class="row">
										<div class="col-sm-6">
											<div class="mb-3">
									...
									<div class="mb-3">
										...
										<button type="submit" class="theme-btn btn-style-two" data-loading-text="Please wait..."><span class="btn-title">Submit Comment</span></button>
									</div>
								</form>
							</div>
						</div>
					...
					<div class="sidebar">
						...
						<div class="sidebar__single sidebar__post">
							...
							<ul class="sidebar__post-list list-unstyled">
								<li>
									<div class="sidebar__post-image"> <img src="images/resource/news-5.jpg" alt=""> </div>
...
<!-- Mirrored from kodesolution.com/html/2023/crotive-html/news-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Jun 2023 14:08:27 GMT -->
</html>